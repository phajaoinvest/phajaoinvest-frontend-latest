      ...
      <main className="container relative z-10 pt-24 pb-20 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="group relative rounded-2xl sm:rounded-3xl border border-white/5 bg-white/[0.03] p-3.5 sm:p-6 backdrop-blur-2xl transition-all duration-300 hover:border-primary/50 hover:bg-white/[0.05] hover:shadow-[0_0_30px_rgba(var(--primary),0.1)]">
                <div className="flex items-start justify-between">
                  <div className="space-y-1 sm:space-y-2">
                    ...
                    <p className="text-base sm:text-2xl font-mono font-black text-primary drop-shadow-[0_0_10px_rgba(var(--primary),0.3)]">
              ...
              <div className="group relative rounded-2xl sm:rounded-3xl border border-white/5 bg-white/[0.03] p-3.5 sm:p-6 backdrop-blur-2xl transition-all duration-300 hover:border-blue-500/50 hover:bg-white/[0.05] hover:shadow-[0_0_30px_rgba(59,130,246,0.1)]">
                <div className="flex items-start justify-between">
                  <div className="space-y-1 sm:space-y-2">
                    ...
                    <p className="text-base sm:text-2xl font-mono font-black text-blue-400 drop-shadow-[0_0_10px_rgba(59,130,246,0.3)]">
              ...
              <div className="group relative rounded-2xl sm:rounded-3xl border border-white/5 bg-white/[0.03] p-3.5 sm:p-6 backdrop-blur-2xl transition-all duration-300 hover:border-purple-500/50 hover:bg-white/[0.05] hover:shadow-[0_0_30px_rgba(168,85,247,0.1)]">
                <div className="flex items-start justify-between">
                  <div className="space-y-1 sm:space-y-2">
                    ...
                    <p className="text-base sm:text-2xl font-mono font-black text-purple-400 drop-shadow-[0_0_10px_rgba(168,85,247,0.3)]">
                ...
                {stocks.map((stock) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group relative rounded-2xl sm:rounded-3xl border p-3 sm:p-5 text-left transition-all duration-300 overflow-hidden backdrop-blur-sm
                        ${isSelected
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
                        <div className={`h-8 w-8 sm:h-12 sm:w-12 rounded-lg sm:rounded-xl flex items-center justify-center border transition-all duration-500
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 mt-auto">
                        <div className="space-y-0.5 sm:space-y-1">
                          ...
                          <p className="text-xs sm:text-xl font-mono font-bold tracking-tight text-white leading-none">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-28">
            <div className={`rounded-3xl border transition-all duration-500 p-6 shadow-2xl backdrop-blur-2xl
              ${selectedStock
              ...
              {!selectedStock ? (
                <div className="flex flex-col items-center justify-center py-20 text-center space-y-6 animate-in fade-in zoom-in duration-700">
                  <div className="relative">
                    ...
                    <div className="relative h-20 w-20 rounded-3xl bg-white/[0.03] flex items-center justify-center text-primary border border-white/10 shadow-2xl backdrop-blur-md">
                ...
                <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500">
                  ...
                  <div className="space-y-4">
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        className="pl-10 h-16 text-2xl font-mono rounded-2xl border-white/10 bg-white/5 text-white focus:border-primary focus:ring-primary/20 transition-all placeholder:text-slate-600"
                      />
                    </div>
                  ...
                  {/* Submit */}
                  <Button
                    className={`w-full h-16 text-base rounded-2xl font-black uppercase tracking-widest transition-all
                      ${canSubmit
      ...
      <Dialog open={showConfirm} onOpenChange={setShowConfirm}>
        <DialogContent className="sm:max-w-md bg-[#0a0a0a] border-white/10 text-white rounded-3xl overflow-hidden">
          ...
          <div className="py-6">
            <div className="rounded-2xl bg-white/[0.03] border border-white/5 p-6 space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-black text-2xl text-white font-mono">{fmtCurrency(amount)}</span>
              </div>
            </div>
          </div>
          <DialogFooter className="flex-col sm:flex-row gap-3">
            ...
            <Button
              className="flex-1 h-12 rounded-xl bg-primary text-white font-bold hover:bg-primary/90"
              onClick={handlePlaceTrade}
              disabled={submitting}
            >
              {submitting ? <Loader2 className="h-5 w-5 animate-spin" /> : t("guess.confirm")}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
          ...
          <div className="py-8 space-y-6">
            ...
            <div className="pt-4 grid grid-cols-1 gap-3">
              <Button
                ...
                className="w-full h-12 rounded-xl bg-white text-black font-black uppercase tracking-widest hover:bg-slate-200"
              >
              ...
              <Button
                ...
                className="w-full h-12 rounded-xl text-slate-500 hover:text-white hover:bg-white/5"
              >
