                           ...
                           <div className="grid md:grid-cols-2 gap-4">
                              <div className="space-y-1">
                                 <Label htmlFor="passport">
                                    {t("app.passport_label")} <span className="text-rose-500">*</span>
                                 </Label>
                                 <Input
                                    id="passport"
                                    type="file"
